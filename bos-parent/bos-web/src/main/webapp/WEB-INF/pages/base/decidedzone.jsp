...
<script type="text/javascript">
	...
	function doAssociations(){
		...
		if(row.length ==0){
			...
			//发送ajax请求，请求定区action，在定区action中通过crm代理对象完成对于crm服务远程调用
			...
			//发送ajax请求，请求定区action，在定区action中通过crm代理对象完成对于crm服务远程调用
			var url_2="DecidedzoneAction_findListAssociation";
			var	decidedzoneId=row[0].id;
	...
	function doDblClickRow(index,data){	
		...
		$('#association_customer').datagrid( {
			...
			rownumbers : true,
			striped : true,
			url : "DecidedzoneAction_findListAssociation.action?id="+data.id,
			columns : [[{
				field : 'id',
				title : '客户编号',
				width : 120,
						...
						<td>
							...
							<script type="text/javascript">
								...
								$('#associationBtn').click(function(){
									...
									//提交表单前，需要将右侧下拉框的选项选中，为option添加一个selected属性
